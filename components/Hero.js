...
const Hero = () => {
  return (
    <div className="container mx-auto my-10 px-16 ">
      <div className="bg-[#fff5f1] px-6 lg:px-20 py-10 rounded-3xl">
        <Navbar />
        <div className="flex flex-col lg:flex-row justify-center  lg:justify-between items-center gap-5">
          <div className="flex flex-col gap-5 lg:gap-10">
            ...
            <button className="btn btn-sm lg:btn-lg bg-[#524fd5] text-white rounded-full border-none w-36 lg:w-44 h-10 capitalize">Get Started</button>
          </div>
